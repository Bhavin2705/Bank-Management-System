...
const register = async (req, res) => {
    try {
        ...
        const userData = {
            ...
            // accountNumber will be generated by pre-save hook
        ...
        await user.save();
        console.log('[REGISTER] Created user:', user._id, 'firstLogin:', user.firstLogin);
...
const login = async (req, res) => {
    try {
        ...
        // If firstLogin is true, set it to false
        if (user.firstLogin) {
            console.log('[LOGIN] User', user._id, 'firstLogin before login:', user.firstLogin);
        ...
        // Always log after login save
        const freshUser = await User.findById(user._id);
        console.log('[LOGIN] User', user._id, 'firstLogin after login:', freshUser.firstLogin);
